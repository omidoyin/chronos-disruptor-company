...
import { Box, Container, Typography, Grid, Card, CardContent, Avatar, Rating, Tabs, Tab, useTheme, useMediaQuery, Button } from '@mui/material';
import { styled } from '@mui/material/styles';
import { motion } from 'framer-motion';
import { FormatQuote, ArrowRight } from '@mui/icons-material';
...
const Testimonials = () => {
  ...
  const filteredTestimonials = category === 'all' 
    ? testimonials 
    : testimonials.filter(testimonial => testimonial.categories.includes(category));
                    ...
                    <Box position="relative" zIndex={1}>
                      ...
                      <Typography 
                        ...
                        sx={{ 
                          mb: 3, 
                          display: '-webkit-box',
                          WebkitLineClamp: expandedTestimonial === testimonial.id ? 'unset' : 4,
        ...
        >
          <Box position="relative" zIndex={1}>
            ...
            <Typography variant="body1" color="text.secondary" sx={{ maxWidth: '600px', mx: 'auto', mb: 4 }}>
              Join our growing list of satisfied clients and experience the difference of working with a team that truly cares about your success.
            </Typography>
            <Button
              href="/contact"
              variant="contained"
